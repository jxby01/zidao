<<<<<<< HEAD:Application/Admin/View/video/video.html
...
<html>
	<head>
		...
		<title>后台模板</title>
		<link rel="stylesheet" href="/Public/Admin/assets/css/amazeui.css" />
		<link rel="stylesheet" href="/Public/Admin/assets/css/core.css" />
		<link rel="stylesheet" href="/Public/Admin/assets/css/menu.css" />
		<link rel="stylesheet" href="/Public/Admin/assets/css/index.css" />
		<link rel="stylesheet" href="/Public/Admin/assets/css/admin.css" />
		<link rel="stylesheet" href="/Public/Admin/assets/css/page/typography.css" />
		<link rel="stylesheet" href="/Public/Admin/assets/css/page/form.css" />
		<link rel="stylesheet" href="/Public/Admin/assets/css/component.css" />
	</head>
	<body>
		<!-- Begin page -->
				...
				<ul class="am-nav am-navbar-nav am-navbar-right">
					...
					<li class="hidden-xs am-hide-sm-only">
                        <form role="search" class="app-search">
                            ...
                            <a href=""><img src="/Public/Admin/assets/img/search.png"></a>
                        </form>
                    </li>
				</ul>
			</div>
				  ...
				  <div class="admin-sidebar am-offcanvas  am-padding-0" id="admin-offcanvas">
				    <div class="am-offcanvas-bar admin-offcanvas-bar">
						...
						<div class="user-box am-hide-sm-only">
	                        <div class="user-img">
	                            <img src="/Public/Admin/assets/img/avatar-1.jpg" alt="user-img" title="Mat Helme" class="img-circle img-thumbnail img-responsive">
					...
					<!-- Row start -->
						<div class="am-u-md-3">
							<div class="card-box widget-user">
                                <div>
                                    <img src="/Public/Admin/assets/img/avatar-3.jpg" class="img-responsive img-circle" alt="user">
						...
						<div class="am-u-md-3">
							<div class="card-box widget-user">
                                <div>
                                    <img src="/Public/Admin/assets/img/avatar-2.jpg" class="img-responsive img-circle" alt="user">
                                    <div class="wid-u-info">
                                        <h4 class="m-t-0 m-b-5 font-600">Chadengle</h4>
                                        <p class="text-muted m-b-5 font-13">coderthemes@gmail.com</p>
						...
						<div class="am-u-md-3">
							<div class="card-box widget-user">
                                <div>
                                    <img src="/Public/Admin/assets/img/avatar-4.jpg" class="img-responsive img-circle" alt="user">
                                    <div class="wid-u-info">
                                        <h4 class="m-t-0 m-b-5 font-600">Chadengle</h4>
                                        <p class="text-muted m-b-5 font-13">coderthemes@gmail.com</p>
						...
						<div class="am-u-md-3">
							<div class="card-box widget-user">
                                <div>
                                    <img src="/Public/Admin/assets/img/avatar-10.jpg" class="img-responsive img-circle" alt="user">
                                    <div class="wid-u-info">
                                        <h4 class="m-t-0 m-b-5 font-600">Chadengle</h4>
                                        <p class="text-muted m-b-5 font-13">coderthemes@gmail.com</p>
								...
								<div class="inbox-widget nicescroll" style="height: 315px; overflow: hidden; outline: none;" tabindex="5000">
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="/Public/Admin/assets/img/avatar-1.jpg" class="img-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="/Public/Admin/assets/img/avatar-2.jpg" class="img-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="/Public/Admin/assets/img/avatar-10.jpg" class="img-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="/Public/Admin/assets/img/avatar-4.jpg" class="img-circle" alt=""></div>
                                    ...
                                    <a href="#">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="/Public/Admin/assets/img/avatar-5.jpg" class="img-circle" alt=""></div>
...
>>>>>>> 09ec9f001abaf109fc561dcc6f73a3de76d647a2:Application/Runtime/Cache/Admin/2762b3687bbab4540577d99de024d37b.php
...
=======
		...
		<script type="text/javascript" src="/Public/Admin/assets/js/jquery-2.1.0.js" ></script>
		<script type="text/javascript" src="/Public/Admin/assets/js/amazeui.min.js"></script>
		<script type="text/javascript" src="/Public/Admin/assets/js/app.js" ></script>
		<script type="text/javascript" src="/Public/Admin/assets/js/blockUI.js" ></script>
		<script type="text/javascript" src="/Public/Admin/assets/js/charts/echarts.min.js" ></script>
		<script type="text/javascript" src="/Public/Admin/assets/js/charts/indexChart.js" ></script>
