...
>>>>>>> 09ec9f001abaf109fc561dcc6f73a3de76d647a2
	</head>
	<body>
		<!-- Begin page -->
				    ...
				    <div class="am-offcanvas-bar admin-offcanvas-bar">
	                    ...
	                    <!-- End User -->
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li class="admin-parent">
						      <a class="am-cf" data-am-collapse="{target: '#collapse-nav6'}"><span class="am-icon-file-video-o"></span> 视频 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
						      <ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav6">
						        <li><a href="<?php echo U('Admin/video/video');?>" class="am-cf">视频列表</span></a></li>
						        <li><a href="<?php echo U('Admin/video/video_fenl');?>">视频分类列表</a></li>
						      </ul>
						    </li>
							 <li class="admin-parent">
						      <a class="am-cf" data-am-collapse="{target: '#collapse-nav4'}"><span class="am-icon-power-off"></span> 权限 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
						      <ul class="am-list am-collapse admin-sidebar-sub" id="collapse-nav4">
						        ...
						        <li><a href="<?php echo U('Admin/Power/admin_list');?>">管理员列表</a></li>
						      </ul>
						    </li>
						    <li class="admin-parent">
