					...
					<!-- Row start -->
						<div class="am-u-sm-12">
							<div class="card-box">
								...
								<h4 class="header-title m-t-0 m-b-30">修改新闻分类栏目</h4>
										...
										<form class="am-form am-text-sm" action="<?php echo U('NewsCloumnLogic/cloumn_eitd');?>" method="post" enctype="multipart/form-data">
											...
											<div class="am-form-group">
												<div class="am-g">
											      ...
											      <input class="am-u-md-10 form-control" value="<?php echo ($row['name']); ?>" name="name" id="doc-ipt-text-1" placeholder="输入栏目名称">
										      </div>
										    </div>
										    ...
										    <div class="am-form-group">
												<div class="am-g">
											      <label class="am-u-md-2 am-md-text-right am-padding-left-0" for="doc-ipt-text-1">栏目原图</label>
											      <img style="width:150px" src="/<?php echo ($row['img']); ?>" />
										      </div>
										    </div>
